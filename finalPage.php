...
<div class="final-page">
    <div class="header-supliment">
        <div class="header-supliment-content" style="gap: 0.5rem;">
            ...
            <div class="hscc">
                <a href="mobile-top-up.php"><span>Mobile top-up</span></a>
            </div>
            <div class="hscc">
                <span><i class="ri-arrow-right-s-line right-arow"></i></span>
            </div>
    ...
    <div class="brand-banner">
        <div class="brand-banner-img">
            <img src="assets/img/brand-banner.png" alt="brand-banner">
        </div>
    </div>
    <div class="brand-header">
        <div class="bh-header">
            <div class="bhh-image">
                <img src="assets/img//lycamobile_final.png" alt="lyca_logo">
            </div>
            <div class="bhh-name">
                <span>Lycamobile Recharge</span>
            </div>
        </div>
    ...
    <div class="brand-recharge-details">
        ...
        <div class="mtuc-mobile">
            ...
            <div class="brd-country">
                <div class="brdc-country">
                    <img src="assets/img/usa.jpeg" alt="usa">
                    <span>+1 7184500708</span>
                </div>
                <div class="brdc-icon"><i class="ri-edit-line"></i></div>
            </div>
        </div>
